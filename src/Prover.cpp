...
void Prover<FieldT>::generate_proof()
{
	...
	r1cs_gg_ppzksnark_proof<FieldT> pf = r1cs_gg_ppzksnark_prover<FieldT>(this->keypair->pk, this->system.primary_input, this->system.auxiliary_input);
